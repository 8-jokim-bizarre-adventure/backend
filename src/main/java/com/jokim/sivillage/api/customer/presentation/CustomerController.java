...
public class CustomerController {
    ...
    public BaseResponse<SignInResponseVo> oauthSignIn(
        ...
        // 소셜 로그인 처리
        SignInResponseDto responseDto = customerService.oauthSignIn(
            OauthSignInRequestDto.toDto(oauthSignInRequestVo));
    ...
    @Operation(summary = "Refresh AccessToken API", description = "리프레시 토큰을 사용하여 새로운 액세스 토큰을 재발급합니다.", tags = {
        "Auth"})
    ...
    public BaseResponse<RefreshTokenResponseVo> refreshAccessToken(
        ...
        try {
            ...
            RefreshTokenResponseDto responseDto = customerService.refreshAccessToken(
                RefreshTokenRequestDto.toDto(refreshToken));
